...
class CarreraController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('carreras-cupos-grupos.carreras.index', [
                'carreras' => $carreras
            ]);
        } catch (\Exception $e) {
    ...
    {
        try {
            return view('carreras-cupos-grupos.carreras.create');
        } catch (\Exception $e) {
            return redirect()->back()
    ...
    public function show($id)
    {
        try {
            ...
            return view('carreras-cupos-grupos.carreras.show', [
                'carrera' => $carrera,
    ...
    public function edit($id)
    {
        try {
            ...
            return view('carreras-cupos-grupos.carreras.edit', [
                'carrera' => $carrera
            ]);
        } catch (\Exception $e) {
            return redirect()->back()
    ...
    public function asignarCupo($id)
    {
        try {
            ...
            return view('carreras-cupos-grupos.carreras.asignar-cupo', [
                'carrera' => $carrera,
                'gestiones' => $gestiones,
