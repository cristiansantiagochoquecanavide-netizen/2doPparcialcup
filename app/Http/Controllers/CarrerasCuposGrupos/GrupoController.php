...
class GrupoController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('carreras-cupos-grupos.grupos.index', [
                'grupos' => $grupos
            ]);
        } catch (\Exception $e) {
    ...
    {
        try {
            return view('carreras-cupos-grupos.grupos.create');
        } catch (\Exception $e) {
            return redirect()->back()
    ...
    public function show($id)
    {
        try {
            ...
            return view('carreras-cupos-grupos.grupos.show', [
                'grupo' => $grupo,
                'ocupacion' => $ocupacion
            ]);
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        try {
            ...
            return view('carreras-cupos-grupos.grupos.edit', [
                'grupo' => $grupo
            ]);
        } catch (\Exception $e) {
            return redirect()->back()
    ...
    {
        try {
            return view('carreras-cupos-grupos.grupos.calcular', [
