...
class PostulanteController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return view('postulantes-inscripcion.postulantes.index', [
    ...
    public function create()
    {
        try {
            ...
            return view('postulantes-inscripcion.postulantes.create', [
                'carreras' => $carreras
            ]);
        } catch (\Exception $e) {
            return redirect()->back()
    ...
    public function preRegistro()
    {
        ...
        return view('postulantes-inscripcion.postulantes.pre-registro', [
            'carreras' => $carreras
        ]);
    }
    ...
    public function show($id)
    {
        try {
            ...
            return view('postulantes-inscripcion.postulantes.show', [
    ...
    public function edit($id)
    {
        try {
            ...
            return view('postulantes-inscripcion.postulantes.edit', [
                'postulante' => $postulante,
                'carreras' => $carreras
            ]);
        } catch (\Exception $e) {
