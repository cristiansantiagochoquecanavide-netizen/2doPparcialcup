        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('postulantes.store') }}" method="POST">
                    ...
                    {{-- Datos personales obligatorios: coinciden con las reglas required del controlador. --}}
                    <div class="row">
                    ...
                    {{-- Fecha, sexo y estado administrativo del postulante. --}}
                    <div class="row">
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('estado') is-invalid @enderror" id="estado" name="estado" required>
                                <option value="PENDIENTE_VALIDACION" @selected(old('estado') === 'PENDIENTE_VALIDACION')>PENDIENTE_VALIDACION</option>
                                <option value="REGISTRADO" @selected(old('estado', 'REGISTRADO') === 'REGISTRADO')>REGISTRADO</option>
                                <option value="VALIDADO" @selected(old('estado') === 'VALIDADO')>VALIDADO</option>
                                <option value="INSCRITO" @selected(old('estado') === 'INSCRITO')>INSCRITO</option>
                    ...
                    {{-- Datos de contacto: el correo es obligatorio, valido y unico. --}}
                    <div class="row">
